...
#if defined(NDEBUG)
#error "Nex cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Nex Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0) return 75000 * COIN;
    if (nHeight == 1) return 20000 * COIN;
