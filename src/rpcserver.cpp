...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NEX features */
        {"nex", "masternode", &masternode, true, true, false},
        {"nex", "masternodelist", &masternodelist, true, true, false},
        {"nex", "mnbudget", &mnbudget, true, true, false},
        {"nex", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"nex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nex", "mnsync", &mnsync, true, true, false},
        {"nex", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"nex", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nexd, or the -server option to nex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nex-cli " + methodname + " " + args + "\n";
}
