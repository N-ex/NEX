/* src/config/nex-config.h.  Generated from nex-config.h.in by configure.  */
/* src/config/nex-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://nex.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Nex Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Nex Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nex"
