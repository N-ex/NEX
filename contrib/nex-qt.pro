...
RESOURCES += src/qt/nex.qrc src/qt/nex_locale.qrc

TRANSLATIONS += src/qt/locale/nex_bg.ts \
                src/qt/locale/nex_de.ts \
                src/qt/locale/nex_en.ts \
                src/qt/locale/nex_es.ts \
                src/qt/locale/nex_fi.ts \
                src/qt/locale/nex_fr.ts \
                src/qt/locale/nex_it.ts \
                src/qt/locale/nex_ja.ts \
                src/qt/locale/nex_pl.ts \
                src/qt/locale/nex_pt.ts \
                src/qt/locale/nex_ru.ts \
                src/qt/locale/nex_sk.ts \
                src/qt/locale/nex_sv.ts \
                src/qt/locale/nex_vi.ts \
                src/qt/locale/nex_zh_CN.ts \
                src/qt/locale/nex_zh_TW.ts
