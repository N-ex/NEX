UNIX BUILD NOTES
====================
Some notes on how to build Nex in Unix.
...
memory available when compiling Nex Core. With 512MB of memory or less
...
If you want to build Nex-Qt, make sure that the required packages for Qt development
...
# Configure Nex Core to use our own-built instance of BDB
cd $Nex_ROOT
...
Security
--------
To help make your Nex installation more secure by making certain attacks impossible to
