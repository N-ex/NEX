...
*Setup instructions for a gitian build of Nex using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Nex
...
- [Building Nex](#building-digiwage)
...
To build Nex (for Linux, OSX and Windows) just follow the steps under 'perform
