...
It is possible to run Nex as a Tor hidden service, and connect to such services.
...
Run Nex behind a Tor proxy
----------------------------------

The first step is running Nex behind a Tor proxy. This will already make all
