Nex Core version 2.3.1 is now available from:
...
Nex Core is extensively tested on multiple operating systems using
...
Nex Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) Nex address of payment
